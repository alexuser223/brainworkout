    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 text-gray-900 p-6">
      {step === 2 && (
        <div className="text-center">
          ...
          <button onClick={() => selectRange(20)} className="m-2 px-6 py-3 bg-yellow-500 text-white rounded-md hover:bg-yellow-600">Up to 20</button>
          <button onClick={() => selectRange(30)} className="m-2 px-6 py-3 bg-orange-500 text-white rounded-md hover:bg-orange-600">Up to 30</button>
          <button onClick={() => selectRange(50)} className="m-2 px-6 py-3 bg-red-500 text-white rounded-md hover:bg-red-600">Up to 50</button>
        </div>
      )}

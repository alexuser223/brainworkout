      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="text-2xl font-bold text-white flex items-center">
            ...
            <NavLink href="/" label="Brain Workout" onClick={() => setIsOpen(false)} />
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-gradient-to-r from-green-500 to-green-800 shadow-md py-4">
          <div className="flex flex-col space-y-2 px-4">
            <NavLink href="/" label="Home" icon={<FaHome />} onClick={() => setIsOpen(false)} />
            <NavLink href="/buy-me-a-coffee" label="Buy Me a Coffee" icon={<FaCoffee />} onClick={() => setIsOpen(false)} />
            <NavLink href="mailto:mkpcpc28@gmail.com" label="mkpcpc28@gmail.com" icon={<FaEnvelope />} onClick={() => setIsOpen(false)} />
          </div>
        </div>
      )}
    </nav>
